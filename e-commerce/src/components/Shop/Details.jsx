...
const Details = () => {
  ...
  useEffect(() => {
    setDetailedProduct(
      data.filter((product) => product.id === parseInt(linkedProduct.id))
    );
  }, []);
  ...
  return (
    <div className="details">
      <SubHeader loc={"Home . Pages"} path={"Product Details"} />
                ...
                <div className="row d-flex justify-content-center align-items-center gap-5 gap-lg-0">
                  ...
                  <div className="col-12 col-lg-8 ">
                    ...
                    <div className="product-body mt-4">
                      ...
                      <p className="description-title mt-4 fw-bold">
                        Description
                      </p>
                      <p className="description m-0 mt-1 lh-lg">
                        {product.description}
                      </p>
                    </div>

  ...
  return (
    <div className="home">
      <div className="subheader">
        <div className="container-lg d-flex justify-content-between align-items-center py-5">
          <div className="left text-center text-md-start">
            <img src={lamp_img} alt="" className="lamp_img d-none d-lg-block" />
            <Typography>Best Furniture For Your Castle....</Typography>
      ...
      <div className="featured-products section">
        <div className="styled-h2">Featured Products</div>
            ...
            <div className="col-12 col-md-7 d-flex justify-content-center align-items-center">
              <div className="content w-100 w-lg-50 ms-5">
                ...
                <div className="content-product-details d-flex justify-content-start align-items-center gap-4">
                  <div className="btn add-to-cart-btn">Add To Cart</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="discount-item section d-flex justify-content-center align-items-center flex-column">
        <div className="styled-h2">Discount Item</div>
        <div className="container-lg text-center text-lg-start d-flex justify-content-center align-items-center mt-5">
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="content">
                <div className="styled-h2 my-4 text-center text-lg-start">
                  20% Discount Of All Products
                </div>
                <h5 className="mt-2">Eams Sofa Compact</h5>
                <p className="w-100 mt-4">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Aspernatur, rem aliquid assumenda voluptates quisquam
                  perspiciatis ipsa nisi si eos?
                </p>
                <div className="row">
                  <div className="col-6">
                    <p>
                      <i className="bi bi-check-lg"></i> Material expose like
                      metals
                    </p>
                    <p>
                      <i className="bi bi-check-lg"></i> Clear lines and
                      geomatric figures
                    </p>
                  </div>
                  <div className="col-6">
                    <p>
                      <i className="bi bi-check-lg"></i> Simple neutral colours.
                    </p>
                    <p>
                      <i className="bi bi-check-lg"></i> Material expose like
                      metals
